...
public class WaveMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            tempPos = posOffset;
            tempPos += moveX ? new Vector3(Mathf.Sin(Time.fixedTime * Mathf.PI * frequency) * amplitude, 0, 0) : new Vector3(0, Mathf.Sin(Time.fixedTime * Mathf.PI * frequency) * amplitude, 0);
